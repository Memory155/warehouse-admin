  ...
  return (
    <div className="min-h-screen bg-zinc-100 text-zinc-900">
      <aside
        className={
          sidebarCollapsed
            ? "fixed left-0 top-0 z-40 h-screen w-[88px] border-r border-zinc-200 bg-white p-2 transition-all duration-300 ease-in-out"
            : "fixed left-0 top-0 z-40 h-screen w-64 border-r border-zinc-200 bg-white p-4 transition-all duration-300 ease-in-out"
        }
      >
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    className="rounded-md border border-zinc-200 p-1.5 text-zinc-600 hover:bg-zinc-100 hover:text-zinc-900"
      ...
      <main
        className="min-h-screen bg-zinc-100 p-6 transition-[margin-left] duration-300 ease-in-out"
        style={{ marginLeft: sidebarCollapsed ? 88 : 256 }}
      >
        {children}
      </main>
      {logoutConfirmOpen ? (
